 ...
 */
public class ConstTreeCopyAdapter extends AbstractAdapter implements SelectionListener {
    public ConstTreeCopyAdapter(ConstCodeViewPage pageObject) {
        super(pageObject);
    }
    @Override
    public void widgetSelected(SelectionEvent e) {
        ...
        while (iterator.hasNext()) {
            ...
            stringBuf.append(bridge.getCode() + "\r");
        }
