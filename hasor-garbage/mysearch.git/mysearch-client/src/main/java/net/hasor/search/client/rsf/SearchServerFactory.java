...
public class SearchServerFactory {
    ...
    //
    public SearchServer connect(String hostIP, int hostPort, String unit) throws Throwable {
        InterAddress rsfAddress = new InterAddress(hostIP, hostPort, unit);
        return new SearchServer(rsfAddress, this);
    }
}